...
namespace Analysistem.Utils
{
    ...
    public struct EventInfo
    {
        ...
        public EventInfo(Target[] targets, double delay, string fileName = "")
        {
            this.targets = (Target?[])(from target in targets select (Target?)target);
            this.delay = delay;
            this.fileName = fileName;
        }
    ...
    static class FakeUser
    {
        ...
        //public static readonly TemplateDictionary encodedTemplates = new TemplateDictionary()
        //{
        //    { Template.SparkvueStart, TemplateData.Empty },
        //    { Template.SparkvueStop, TemplateData.Empty },
        //    { Template.HamburgerButton, TemplateData.Empty },
        //    { Template.ExportData, TemplateData.Empty }
        //};
        #endregion
